...
import ua.lil.proxy.configuration.Configuration;
import ua.lil.proxy.configuration.ConfigurationProvider;
import ua.lil.proxy.configuration.YamlConfiguration;
...
public class Config {
    ...
    private void set(String key, Object value) {
        ...
        System.out.println("Failed to set config option: {0}: {1} | {2} ");
    }
    ...
    public boolean load(File file) {
        ...
        try {
            ...
            System.out.println("Не могу загрузить конфиг " + ex.getMessage());
            return false;
        }
        set(yml, "");
        return true;
